...
const LandingPage = () => {
  return (
    <MainLayout>
      <div className="bg-primaryText h-[90.5vh] grid grid-cols-[1.5fr_1fr] gap-24">
        <div className="flex flex-col justify-center gap-y-10 px-52">
        ...
        <div className="bg-red-500">
          <img src='/src/assets/landingPagePhoto.png' className='h-[90.5vh]'></img>
        </div>
      </div>
    </MainLayout>
  )
